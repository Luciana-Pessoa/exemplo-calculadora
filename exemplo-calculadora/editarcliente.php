...
include("system/editarcliente.php.inc");
                ...
                <form action="">
                    <div class="row d-flex justify-content-center" id="editar">
                        <div class="input-group mb-3">
                            <label class="col-lg-2  input-group-text" for="name">Nome Fantasia:</label>
                            <input type="text" name="name" class="flex-fill bd-highlight" id="name">
                        </div>
                        <br>
                        <div class="input-group mb-3">
                            <label class="col-lg-2 input-group-text" for="razao_social">Razao Social: </label>
