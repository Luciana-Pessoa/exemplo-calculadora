            ...
            <div class="col-6">
                ...
                <form action="">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button onclick="window.location.href='//minas/xajax/luciana/exemplo-calculadora/clientes_cadastrados.php'" class="btn btn-warning" type="button">IR A LISTA DE CLIENTES CADASTRADOS</button>
                    </div>
                </form>
            </div>
